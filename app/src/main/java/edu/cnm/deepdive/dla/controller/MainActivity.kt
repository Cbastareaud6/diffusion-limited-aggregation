...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViewModel() {
        ...
        viewModel = ViewModelProvider(this)
            ...
            .apply {
                ...
                throwable.observe(owner) { handleThrowable(it) }
            }
    ...
    private fun setupUI() {
        ...
        binding = DataBindingUtil
            ...
            lattice.onSeedListener  = {_: LatticeView, x: Int, y: Int -> owner.viewModel.set(x, y)
            }
        }
    }
    ...
    private fun handleThrowable(throwable: Throwable?) {
        throwable?.let {
            Toast
                .makeText(this, throwable.message, Toast.LENGTH_LONG)
                .show()
        }
    }
}